...
```bash
# 只支持 release, 其他模式 link 会失败
cargo run --release --bin whep-player play-whep "http://volcvideo19.zelostech.com.cn:1790/rtc/v1/whep/?app=live&stream=ZL20621/bleft" -v
```
